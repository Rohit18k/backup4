...
public class PublicformRailoneApplication extends TestBase1{

	Random r=new Random();
	
	public PublicformRailoneApplication() {
	super();
	}
	...
	*/
	  ...
	  @Test(priority=2)
		public void publicFormRailone() throws Exception {
			Thread.sleep(5000);
			driver.navigate().to("https://test1.wazecapital.com/index.html?vendor_id=60be31dc457c420008444b80");
			driver.manage().window().maximize();
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
			   ...
			   try {
				     ...
				     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[1]/div/input[1]")).sendKeys("Savannah");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
			   ...
			   try {
				   ...
				   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[2]/div/input")).sendKeys("Kennedy");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
			   ...
			   try {
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[5]/div/input")).sendKeys("90000");
		...
		driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[12]/div/div/div/ul/li[2]/a/span[1]")).click();
			...
			Thread.sleep(3000);
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[16]/div/input")).sendKeys("80000");
				...
				JavascriptExecutor js3 = (JavascriptExecutor) driver;
				   js3.executeScript("window.scrollBy(0,50)");
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[19]/div/div/button/span[1]")).click();
					Thread.sleep(3000);
				    driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[19]/div/div/div/ul/li[1]/a/span[1]")).click();
				    Thread.sleep(3000);
					...
					Thread.sleep(3000);
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[20]/div/div/div/ul/li[3]/a")).click();
