...
public class RailOneInitiateApplication extends TestBase1{

	Random r=new Random();
	
	public RailOneInitiateApplication() {
	super();
	}
	...
	WebElement sidebar=	driver.findElement(By.xpath("/html/body/nav/div[3]/div[2]/div"));
	 ...
	 @Test(priority=2) 	
	 public void createApplicationRailOne() throws Exception {
		  Thread.sleep(5000);	 
	 	   ...
	 	   driver.manage().window().maximize();
	 		  ...
	 		  Thread.sleep(2000);
	 		   ...
	 		   try { 
	 				 ...
	 				 driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("As!!!!!");
	 				 driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).clear();
	 				  
	 				  RandomStringUtils r=new RandomStringUtils();
					   String withoutoptin="John"+r.randomAlphabetic(8);
	 			     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys(withoutoptin);
	 				 }catch(Exception e) {
	 					 e.printStackTrace();
	 				 }
	 		   ...
	 		   try {
	 			  ...
	 			  driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("Qs!!!!!");
	 			  driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).clear();
	 			   
	 			  RandomStringUtils r=new RandomStringUtils();
				   String withoutoptin="shoy"+r.randomAlphabetic(8);
				   
	 			   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys(withoutoptin);
	 				 }catch(Exception e) {
	 					 e.printStackTrace();
	 				 }
	 		   ...
	 		   try {
	 				 ...
	 				 driver.findElement(By.xpath("//*[@id=\"ssn_number\"]")).sendKeys("678-98");
	 			 ...
	 			 Thread.sleep(1000);
	 				...
	 				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[5]/div/input")).sendKeys("A@@@@ssssddddf");
	 			...
	 			JavascriptExecutor js4 = (JavascriptExecutor) driver;	
	 			   ...
	 			   String text10=driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[1]/div/label[2]")).getText();
	 				...
	 				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[1]/div/input")).sendKeys("A**&asdsddd");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[1]/div/input")).sendKeys(num);
	 			...
	 			try {
	 				...
	 				String email="testing"+r.nextInt(1000)+"@gmail.com";
	 				
	 				
	 		driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).sendKeys(email);}
	 			catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[3]/div/input")).sendKeys("Washington Dc state");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).click();
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).sendKeys("123@@##");
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).clear();
	 			
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).sendKeys("Florida");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).click();
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).sendKeys("Aq!@@#");
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).clear();
	 			
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).sendKeys("25695");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[3]/div[2]/div/input")).sendKeys("Au@!@@##");
	 			...
	 			JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 			  ...
	 			  String text7=driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[4]/div[3]/div/label[2]")).getText();
	 				...
	 				slt6.selectByValue("rent");
	 				 ...
	 				 String text81=driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[5]/div[3]/label[2]")).getText();
			 			System.out.println(text81);
			 			String exp81="Please enter app_phn";
			 			Assert.assertEquals(text81,exp81);
	 				
			 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[5]/div[3]/input")).click();
			 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[5]/div[3]/input")).sendKeys("Ad!@#$");
			 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[5]/div[3]/input")).clear();
			 			
			 			
			 			
			 			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[5]/div[3]/input")).sendKeys("8956324578");
	 				try {
	 				Thread.sleep(2000);
