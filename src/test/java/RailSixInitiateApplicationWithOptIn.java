...
public class RailSixInitiateApplicationWithOptIn extends TestBase1{
	Random r=new Random();

	public RailSixInitiateApplicationWithOptIn() {
	super();
	}
	      ...
	      JavascriptExecutor js34 = (JavascriptExecutor) driver;
		   ...
		   try {
			...
			try {
				...
				String email="automate_test"+r.nextInt(1000)+"@gmail.com";
		...
		driver.findElement(By.xpath("//*[@id=\"liberty_application_form\"]/div[2]/div[2]/div/input")).sendKeys(email);}
			...
			slt45.selectByIndex(2);}catch(Exception e) {
			 ...
			 String text6=driver.findElement(By.xpath("//*[@id=\"liberty_application_form\"]/div[4]/div[2]/div/label[2]")).getText();
				...
				driver.findElement(By.xpath("//*[@id=\"liberty_application_form\"]/div[5]/div[3]/div/input")).sendKeys("9752345874");
//				
				  ...
				  WebElement closebutton=  driver.findElement(By.xpath("//*[@id=\"sms_history\"]/div/div/div[3]/button"));
				   ...
				   String url=driver.findElement(By.xpath("//*[@id=\"short_url\"]")).getText();
					 ...
					 JavascriptExecutor js82 = (JavascriptExecutor) driver;
					   ...
					   Thread.sleep(2000);   
						   WebElement element = driver.findElement(By.xpath("/html/body/div[4]/div[2]/form/div[5]/div[2]/div/input"));
...
// 	   js2.executeScript("window.scrollTo(0, document.body.scrollHeight)");
		...
		//note:1.optin page not redirecting to offers page, 2.under action dropdown run button , app history page status: application sent to applicant
		//changed checkbox xpath for optin page, removed cust5 id
}
