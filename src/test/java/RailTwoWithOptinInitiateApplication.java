...
public class RailTwoWithOptinInitiateApplication extends TestBase1{

	Random r=new Random();
	
	public RailTwoWithOptinInitiateApplication() {
	super();
	}
...
/*
	...
	*/
	 ...
	 @Test(priority=2) 	
	 public void createRailtwoWithoptinApplication() throws Exception {
	      ...
	      JavascriptExecutor js34 = (JavascriptExecutor) driver;
		   ...
		   String text100=driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div[1]/div/label[2]")).getText();
	 	   ...
	 	   try {
	 		   Thread.sleep(1000); 
	 			 ...
	 			 RandomStringUtils r=new RandomStringUtils();
	 			   String withoptin="Railtwo"+r.randomAlphabetic(8);
	 		     driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys(withoptin);
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   ...
	 	   try {
	 		  ...
	 		  RandomStringUtils r=new RandomStringUtils();
			   String withoptin="withoptin"+r.randomAlphabetic(8);
	 		   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div[2]/div/input")).sendKeys(withoptin);
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   ...
	 	   try {Thread.sleep(1000);
	 			  ...
	 			  driver.findElement(By.xpath("//*[@id=\"social_security_number\"]")).sendKeys("145-18-4568");
	 			 }catch(Exception e) {  
	 				 e.printStackTrace();
	 			 }
	 		...
	 		try {
	 			Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[2]/div[4]/div/input")).sendKeys("Webtech Solutions");}
	 		catch(Exception e) {
	 			 e.printStackTrace();
	 		 }
	 		...
	 		try {
	 			Thread.sleep(1000);
	 			String email="testnicode"+r.nextInt(1000)+"@gmail.com";
	 	driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[2]/div/input")).sendKeys(email);}
	 		...
	 		JavascriptExecutor js5 = (JavascriptExecutor) driver;
	 		   ...
	 		   String text12=driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[3]/div/label[2]")).getText();
	 			...
	 			Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[3]/div/input")).sendKeys("Washington state Dc");
	 		...
	 		Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[6]/div/input")).sendKeys("56165");
	 		...
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[4]/div[2]/div/input")).sendKeys("50000");
	 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 		   js3.executeScript("window.scrollBy(0,50)");
	 		   
	 			driver.findElement(By.xpath("//input[@id='co_app']")).click();
	 			Thread.sleep(1000);
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[3]/div/input")).sendKeys("Apptesting");
	 			...
	 			Thread.sleep(2000);
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[10]/div/input")).sendKeys("45473");
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[11]/div/input")).sendKeys("200000");
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[13]/input")).sendKeys("9532753685");
		 		...
		 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[7]/div[3]/input")).sendKeys("9832457524");
						  ...
						  JavascriptExecutor js21= (JavascriptExecutor) driver;
						   ...
						   String url=driver.findElement(By.xpath("//*[@id=\"short_url\"]")).getText();
							 ...
							 JavascriptExecutor js82 = (JavascriptExecutor) driver;
							   ...
							   Thread.sleep(2000); 
								   WebElement element = driver.findElement(By.xpath("/html/body/div[4]/div[1]/form/div[6]/div[2]/div/input"));
...
//					
//	
//					String email="resubmitrailtwoptin"+r.nextInt(1000)+"@gmail.com";
