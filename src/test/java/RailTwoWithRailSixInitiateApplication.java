...
public class RailTwoWithRailSixInitiateApplication extends TestBase1{

	Random r=new Random();
	
	public RailTwoWithRailSixInitiateApplication() {
	super();
	}
	...
	public void openBrowser() throws Exception {
	 ...
	 @Test(priority=2) 	
	 public void createRailtwoRailsixApplication() throws Exception {
	      ...
	      JavascriptExecutor js34 = (JavascriptExecutor) driver;
		   ...
		   String text100=driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div[1]/div/label[2]")).getText();
	 	   ...
	 	   try {
	 		  ...
	 		  RandomStringUtils r=new RandomStringUtils();
			   String withoutoptin="Railsixoffers"+r.randomAlphabetic(8);
	 	   ...
	 	   try {Thread.sleep(1000);
	 			  ...
	 			  driver.findElement(By.xpath("//*[@id=\"social_security_number\"]")).sendKeys("4568-71-5698");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 		...
	 		try {
	 			Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[2]/div[4]/div/input")).sendKeys("Software tech service");}
	 		catch(Exception e) {
	 			 e.printStackTrace();
	 		 }
	 		...
	 		try {
	 			Thread.sleep(1000);
	 			String email="railtwooffer"+r.nextInt(1000)+"@gmail.com";
	 	driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[2]/div/input")).sendKeys(email);}
	 		...
	 		JavascriptExecutor js5 = (JavascriptExecutor) driver;
	 		   ...
	 		   String text12=driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[3]/div/label[2]")).getText();
	 			...
	 			Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[3]/div/input")).sendKeys("Washington Dc Road");
	 		...
	 		Thread.sleep(1000);
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[6]/div/input")).sendKeys("56764");
	 		...
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[4]/div[2]/div/input")).sendKeys("80000");
	 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 		   js3.executeScript("window.scrollBy(0,50)");
	 		   
	 			driver.findElement(By.xpath("//input[@id='co_app']")).click();
	 			Thread.sleep(1000);
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[3]/div/input")).sendKeys("test");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[6]/div/input")).sendKeys("Washington Dc");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[9]/div/input")).sendKeys("45483");
...
//		 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[7]/div[2]/input")).sendKeys("800");
			...
			driver.findElement(By.cssSelector("#submit-btn")).click();}
			 	  ...
			 	  Thread.sleep(5000);
			        ...
			        String email="retestsix"+r.nextInt(1000)+"@gmail.com";
