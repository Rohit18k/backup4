...
public class RainOneAfterPreofferprocess extends TestBase1{

	Random r=new Random();
	
	public RainOneAfterPreofferprocess() {
	super();
	}
	 ...
	 */
	 ...
	 @Test(priority=2)
		public void showPreofferAfterpageDropdowmMenu() throws Exception {
			 Thread.sleep(5000);
			driver.navigate().to("https://test.wazecapital.com/settings/set_order");
		...
		WebElement confirm=driver.findElement(By.xpath("//*[@id=\"show_confirmation_page\"]"));
			   ...
			   Thread.sleep(1000);
			   driver.findElement(By.xpath("//form[@id='pre_offer_management']//button[@id='submit-btn-ofr']")).click();
			   Thread.sleep(3000); }
	 

	
	 @Test(priority=3) 	
	 public void createApplicationRailOneAfterPreofferprocess() throws Exception {
		  Thread.sleep(5000);	 
	 	   ...
	 	   driver.manage().window().maximize();
	 		  ...
	 		  Thread.sleep(2000);
	 		   ...
	 		   try { 
	 			     ...
	 			     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Joy");
	 				 }catch(Exception e) {
	 					 e.printStackTrace();
	 				 }
	 		   ...
	 		   try {
	 			   ...
	 			   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("shein");
	 				 }catch(Exception e) {
	 					 e.printStackTrace();
	 				 }
	...
	//note: setofferconfiguration page, values are not selected in offer configurations page
