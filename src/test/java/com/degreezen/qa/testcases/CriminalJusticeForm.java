...
public class CriminalJusticeForm extends TestBase1{


	public CriminalJusticeForm() {
	super();
	}
	...
	public void openBrowser() throws Exception {
	  ...
	  @Test(priority=1)
	     public void  criminalJusticeForm() throws Exception {
	         Thread.sleep(5000);
	 ...
	 Select slt1=new Select( driver.findElement(By.xpath("//*[@id=\"academic_level\"]")));
		slt1.selectByValue("2006");
		 ...
		 Select slt2=new Select(driver.findElement(By.xpath("//*[@id=\"degree\"]")));
			slt2.selectByValue("Certificate");
			 ...
			 Thread.sleep(1000);
				...
				driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys("63244");
		 ...
		 Thread.sleep(1000);
	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 5);
			 ...
			 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"criminal\"]"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element1);
			
		 
			 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"enforcement\"]"))); 
		 ...
		 driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("heena");
		 
		 Thread.sleep(1000);

		 
			 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys("720 SCHILLINGER ROAD S");
			
			 
			
					 
					 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("heena@gmail.com");
				
				 Thread.sleep(1000);
				 

						
		 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys("9521453615");
