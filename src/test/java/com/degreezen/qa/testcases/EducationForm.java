...
public class EducationForm extends TestBase1{
	...
	public void openBrowser() throws Exception {
	  ...
	  @Test(priority=1)
	     public void  educationForm() throws Exception {
	         Thread.sleep(5000);
		...
		slt1.selectByValue("2012");
		 ...
		 Select slt2=new Select(driver.findElement(By.xpath("//*[@id=\"degree\"]")));
			slt2.selectByValue("Bachelors");
			 ...
			 Thread.sleep(1000);
				...
				driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys("64244");
		 ...
		 Thread.sleep(1000);
	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 5);
			 ...
			 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"selecteducation\"]"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element1);
			
		 
			 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"continuing\"]"))); 
		 ...
		 Thread.sleep(1000);
			 ...
			 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys("3232 GALLERIA CIRCLE STE 102");
			
			 
			
					 
					 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("roy@gmail.com");
				
				 Thread.sleep(1000);
				 

						
		 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys("9021453615");
