...
public class PsychForm extends TestBase1{
	...
	public void openBrowser() throws Exception {
	  ...
	  @Test(priority=1)
	     public void  psychForm() throws Exception {
	         Thread.sleep(5000);
		...
		slt1.selectByValue("2014");
		 ...
		 Select slt2=new Select(driver.findElement(By.xpath("//*[@id=\"degree\"]")));
			slt2.selectByValue("Masters");
			 ...
			 Thread.sleep(1000);
				...
				driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys("73244");
		 ...
		 Thread.sleep(1000);
	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 5);
			 ...
			 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"psych\"]"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element1);
			
		 
			 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"socialscience\"]"))); 
		 ...
		 driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("jenny");
		 
		 Thread.sleep(1000);

		 
			 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys("1830 QUINTARD AVE");
			
			 
			
					 
					 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("jenny@gmail.com");
				
				 Thread.sleep(1000);
				 

						
		 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys("9022453615");
