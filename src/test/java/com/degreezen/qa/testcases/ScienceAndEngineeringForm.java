...
public class ScienceAndEngineeringForm extends TestBase1{


	public ScienceAndEngineeringForm() {
	super();
	}
	...
	public void openBrowser() throws Exception {
	  ...
	  @Test(priority=1)
	     public void  scienceAndEngineeringForm() throws Exception {
	         Thread.sleep(5000);
		...
		slt1.selectByValue("2010");
		 ...
		 Select slt2=new Select(driver.findElement(By.xpath("//*[@id=\"degree\"]")));
			slt2.selectByValue("Associates");
			 ...
			 Thread.sleep(1000);
				...
				driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys("63247");
		 ...
		 Thread.sleep(1000);
	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 5);
			 ...
			 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"science\"]"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element1);
			
		 
			 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"aeronautics\"]"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element2);
			
			 
			 WebElement element7 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"physicalsciences\"]"))); 
		 ...
		 driver.findElement(By.xpath("//input[@placeholder='Last Name']")).sendKeys("sana");
		 
		 Thread.sleep(1000);

		 
			 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys("35553 KENAI SPUR HIGHWAY");
			
			 
			
					 
					 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys("sana@gmail.com");
				
				 Thread.sleep(1000);
				 

						
		 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys("9521453625");
