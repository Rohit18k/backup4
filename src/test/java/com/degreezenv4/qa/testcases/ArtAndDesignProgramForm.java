package com.degreezenv4.qa.testcases;
	...
	public void openBrowser() throws Exception {
	  ...
	  @Test(priority=1)
	     public void  artDesignForm() throws Exception {
	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 10);
				...
				Assert.assertEquals(text4,exp4);
				 ...
				 String text41=driver.findElement(By.xpath("//*[@id=\"firstname-error\"]")).getText();
					...
					Assert.assertEquals(text41,exp41);
					 ...
					 driver.findElement(By.xpath("//input[@id='firstname']")).sendKeys(pro.getProperty("firstname4"));
			 ...
			 String text51=driver.findElement(By.xpath("//*[@id=\"lastname-error\"]")).getText();
				...
				driver.findElement(By.xpath("//*[@id=\"lastname\"]")).sendKeys(pro.getProperty("lastname4"));
				...
				Thread.sleep(1000);
				 ...
				 driver.findElement(By.xpath("//*[@id=\"year\"]")).click();
 				 ...
 				 slt21.selectByValue(pro.getProperty("year4"));
		 ...
		 driver.findElement(By.xpath("//*[@id=\"month\"]")).click();
			...
			slt31.selectByValue(pro.getProperty("month4"));
	 ...
	 */
			 String text6=driver.findElement(By.xpath("//*[@id=\"address-error\"]")).getText();
				...
				Assert.assertEquals(text6,exp6);
				 ...
				 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys(pro.getProperty("address4"));
					...
					driver.findElement(By.xpath("//*[@id=\"city\"]")).clear();
									 ...
									 driver.findElement(By.xpath("//*[@id=\"city\"]")).sendKeys(pro.getProperty("city4"));
								     ...
								     WebElement source_dropdown13=wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@id=\"state\"]"))));
	                                    ...
	                                    source13.selectByVisibleText(pro.getProperty("state4"));
				 ...
				 String text11=driver.findElement(By.xpath("//*[@id=\"zip_code-error\"]")).getText();
					...
					driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys(pro.getProperty("zipcode4"));
					...
					Assert.assertEquals(text7,exp7);
					 ...
					 String text13=driver.findElement(By.xpath("//*[@id=\"email-error\"]")).getText();
						...
						Assert.assertEquals(text13,exp13);
						 ...
						 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys(pro.getProperty("email4"));
			 ...
			 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys(pro.getProperty("phonenumber4"));
			 ...
			 String text1=driver.findElement(By.xpath("//*[@id=\"level_of_education-error\"]")).getText();
		  	...
		  	slt.selectByValue(pro.getProperty("levelofeducation4"));
			 ...
			 String text144=driver.findElement(By.xpath("//*[@id=\"academic_level-error\"]")).getText();
				System.out.println(text144);
				String exp144="Please Select Academic Level.";
				Assert.assertEquals(text144,exp144);
			 ...
			 Select slt1=new Select( driver.findElement(By.xpath("//*[@id=\"academic_level\"]")));
				slt1.selectByValue(pro.getProperty("academiclevel4"));
		      
				
				 WebElement element123 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[1]/div/div[2]/div/input"))); 
				 ...
				 String text311=driver.findElement(By.xpath("//*[@id=\"high_school_gpa-error\"]")).getText();
					...
					Assert.assertEquals(text311,exp311);
					 ...
					 driver.findElement(By.xpath("//*[@id=\"high_school_gpa\"]")).sendKeys(pro.getProperty("highschoolGPA4"));
				 ...
				 Select slt2=new Select(driver.findElement(By.xpath("//select[@id='degree']")));
					slt2.selectByValue(pro.getProperty("degree4"));
					 ...
					 WebElement element13 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[1]/div/div[2]/div/input"))); 
					 ...
					 String text321=driver.findElement(By.xpath("//*[@id=\"military_dependent_specific-error\"]")).getText();
                        ...
                        source3.selectByValue(pro.getProperty("military4"));
					 ...
					 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element3112);
					  ...
					  String text3=driver.findElement(By.xpath("//*[@id=\"program-error\"]")).getText();
						...
						Assert.assertEquals(text3,exp3);
						 ...
						 WebElement element18 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("artprogram4")))); 
						 ...
						 WebElement element31121 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[2]/div/div[2]/div/input[1]"))); 
						 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element31121);
		      
		      
						    Thread.sleep(3000);
		      
						    WebElement element21213 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[3]/div/div[2]/div/input[1]"))); 
							 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element21213);
						    
							 String text32=driver.findElement(By.xpath(pro.getProperty("subjecterror4"))).getText();
						    ...
						    WebElement element211 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("subject41")))); 
							 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element211);
		      
		      
							 WebElement element2111 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("subject42")))); 
							 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element2111);
						 
							 WebElement element2123 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[3]/div/div[2]/div/input[1]"))); 
