	  ...
	  @Test(priority=1)
	     public void  artDesign() throws Exception {
		  ...
		  Thread.sleep(5000);
	       ...
	       WebElement element3112 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[3]/div/div[2]/div/input"))); 
			 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element3112);
			  ...
			  String text3=driver.findElement(By.xpath("//*[@id=\"program-error\"]")).getText();
				...
				Thread.sleep(2000);
				 ...
				 WebElement element18 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("arstprogram6")))); 
				 ...
				 WebElement element322 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[4]/div/div[2]/div/input"))); 
				 ...
				 String text32=driver.findElement(By.xpath(pro.getProperty("subjecterror6"))).getText();
					System.out.println(text32);
					String exp32="Please Select A Subject.";
					Assert.assertEquals(text32,exp32);
				 
			 
				 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("subject6")))); 
				 ...
				 Thread.sleep(2000);
				  ...
				  driver.findElement(By.xpath("//*[@id=\"level_of_education\"]")).click();
				  	...
				  	slt.selectByValue(pro.getProperty("levelofeducation6"));
					 ...
					 Select slt1=new Select( driver.findElement(By.xpath("//*[@id=\"academic_level\"]")));
						slt1.selectByValue(pro.getProperty("academiclevel6"));
				 
				 
						Thread.sleep(1000);
						
						driver.findElement(By.xpath("//*[@id=\"msform\"]/fieldset[7]/div/div[2]/div/input")).click();
						
						  String text5=driver.findElement(By.xpath("//*[@id=\"high_school_gpa-error\"]")).getText();
							System.out.println(text5);
							String exp5="Please Enter Highschool Gpa.";
							Assert.assertEquals(text5,exp5);
						
						
						 driver.findElement(By.xpath("//*[@id=\"high_school_gpa\"]")).sendKeys(pro.getProperty("highschoolGPA6"));
						 ...
						 Select slt2=new Select(driver.findElement(By.xpath("//select[@id='degree']")));
							slt2.selectByValue(pro.getProperty("degree6"));
							...
							Thread.sleep(1000);
							  ...
							  Thread.sleep(2000);
								 ...
								 WebElement element232 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[10]/div/div[2]/div/input"))); 
						  ...
						  String text4=driver.findElement(By.xpath("//*[@id=\"firstname-error\"]")).getText();
									...
									Assert.assertEquals(text4,exp4);
									 ...
									 String text41=driver.findElement(By.xpath("//*[@id=\"firstname-error\"]")).getText();
										...
										Assert.assertEquals(text41,exp41);
										 ...
										 driver.findElement(By.xpath("//input[@id='firstname']")).sendKeys(pro.getProperty("firstname6"));
						      
						      
								 String text51=driver.findElement(By.xpath("//*[@id=\"lastname-error\"]")).getText();
									System.out.println(text51);
									String exp51="Please Enter Last Name.";
								 ...
								 String text511=driver.findElement(By.xpath("//*[@id=\"lastname-error\"]")).getText();
									System.out.println(text511);
									String exp511="Please Enter Only Alphabets.";
									Assert.assertEquals(text511,exp511);
									...
									driver.findElement(By.xpath("//*[@id=\"lastname\"]")).sendKeys(pro.getProperty("lastname6"));
									 ...
									 Thread.sleep(1000);
										...
										Thread.sleep(1000);
										 ...
										 driver.findElement(By.xpath("//*[@id=\"year\"]")).click();
						 				 ...
						 				 slt21.selectByValue(pro.getProperty("year6"));
				 				...
				 				slt31.selectByValue(pro.getProperty("month6"));
                                 ...
                                 */
								 ...
								 String text6=driver.findElement(By.xpath("//*[@id=\"address-error\"]")).getText();
									...
									Assert.assertEquals(text6,exp6);
									 ...
									 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys(pro.getProperty("address6"));
					...
					driver.findElement(By.xpath("//*[@id=\"city\"]")).clear();
									 ...
									 driver.findElement(By.xpath("//*[@id=\"city\"]")).sendKeys(pro.getProperty("city6"));
								     ...
								     WebElement source_dropdown21=wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//*[@id=\"state\"]"))));
	                                    ...
	                                    source21.selectByVisibleText(pro.getProperty("state6"));
									 ...
									 String text11=driver.findElement(By.xpath("//*[@id=\"zip_code-error\"]")).getText();
										...
										driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys(pro.getProperty("zipcode6"));
										...
										Assert.assertEquals(text7,exp7);
										 ...
										 String text13=driver.findElement(By.xpath("//*[@id=\"email-error\"]")).getText();
											...
											Assert.assertEquals(text13,exp13);
											 ...
											 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys(pro.getProperty("email6"));
								 ...
								 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys(pro.getProperty("phonenumber6"));
								 
	 driver.findElement(By.xpath("//*[@id=\"flexRadioDefault2\"]")).click();
								 
	 
	 WebElement element121 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[10]/div/div[2]/div/input"))); 
									 ...
									 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element3112);
									  ...
									  String text3=driver.findElement(By.xpath("//*[@id=\"program-error\"]")).getText();
										...
										Assert.assertEquals(text3,exp3);
										 ...
										 WebElement element18 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"programOfInterest\"]/div[1]/label"))); 
										 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element18);
										 ...
										 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"art_and_design\"]/div[2]/label"))); 
										 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element2);
