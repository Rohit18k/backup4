	       ...
	       WebDriverWait wait = new WebDriverWait(driver, 10);
			 ...
			 String text4=driver.findElement(By.xpath("//*[@id=\"firstname-error\"]")).getText();
					...
					Assert.assertEquals(text4,exp4);
					 ...
					 String text41=driver.findElement(By.xpath("//*[@id=\"firstname-error\"]")).getText();
						...
						Assert.assertEquals(text41,exp41);
						 ...
						 driver.findElement(By.xpath("//input[@id='firstname']")).sendKeys(pro.getProperty("firstname7"));
				 ...
				 String text51=driver.findElement(By.xpath("//*[@id=\"lastname-error\"]")).getText();
					...
					driver.findElement(By.xpath("//*[@id=\"lastname\"]")).sendKeys(pro.getProperty("lastname7"));
					...
					Thread.sleep(1000);
					 ...
					 slt21.selectByValue(pro.getProperty("year7"));
			 ...
			 driver.findElement(By.xpath("//*[@id=\"month\"]")).click();
				...
				slt31.selectByValue(pro.getProperty("month7"));
		      ...
		      */
				 ...
				 String text6=driver.findElement(By.xpath("//*[@id=\"address-error\"]")).getText();
					...
					Assert.assertEquals(text6,exp6);
					 ...
					 driver.findElement(By.xpath("//*[@id=\"address\"]")).sendKeys(pro.getProperty("address7"));
...
//
//					 		 
//					 				 driver.findElement(By.xpath("//*[@id=\"city\"]")).sendKeys(pro.getProperty("city7"));
//					 				 
//					 				 
//					 				 
//					 				 
...
//					                    source13.selectByVisibleText(pro.getProperty("state7"));
//						 				
					 				 ...
					 				 String text11=driver.findElement(By.xpath("//*[@id=\"zip_code-error\"]")).getText();
					 					...
					 					driver.findElement(By.xpath("//*[@id=\"zip_code\"]")).sendKeys(pro.getProperty("zipcode7"));
						...
						Assert.assertEquals(text7,exp7);
						 ...
						 String text13=driver.findElement(By.xpath("//*[@id=\"email-error\"]")).getText();
							...
							Assert.assertEquals(text13,exp13);
							 ...
							 driver.findElement(By.xpath("//*[@id=\"email\"]")).sendKeys(pro.getProperty("email7"));
				 ...
				 driver.findElement(By.xpath("//input[@id='phone_number']")).sendKeys(pro.getProperty("phonenumber7"));
					...
					driver.findElement(By.xpath("//*[@id=\"start3\"]")).click();
					 ...
					 driver.findElement(By.xpath("//*[@id=\"flexRadioDefault2\"]")).click();
						 ...
						 String text321=driver.findElement(By.xpath("//*[@id=\"military_dependent_specific-error\"]")).getText();
			                ...
			                source3.selectByValue(pro.getProperty("military7"));
	...
	slt.selectByValue(pro.getProperty("levelofeducation7"));
	...
	Thread.sleep(1000);
	 ...
	 Select slt1=new Select( driver.findElement(By.xpath("//*[@id=\"academic_level\"]")));
		slt1.selectByValue(pro.getProperty("academiclevel7"));
		 ...
		 String text311=driver.findElement(By.xpath("//*[@id=\"high_school_gpa-error\"]")).getText();
			...
			Assert.assertEquals(text311,exp311);
			 ...
			 driver.findElement(By.xpath("//*[@id=\"high_school_gpa\"]")).sendKeys(pro.getProperty("highschoolGPA7"));
		 ...
		 Select slt2=new Select(driver.findElement(By.xpath("//*[@id=\"degree\"]")));
			slt2.selectByValue(pro.getProperty("degree7"));
			...
			WebElement element62 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//*[@id=\"msform\"]/fieldset[3]/div/div[2]/div/input[1]"))); 
			 ...
			 String text3=driver.findElement(By.xpath("//*[@id=\"program-error\"]")).getText();
				...
				Assert.assertEquals(text3,exp3);
				 ...
				 WebElement element1 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("artprogram7")))); 
				 ...
				 ((JavascriptExecutor)driver).executeScript("arguments[0].click();", element341);
				  ...
				  String text32=driver.findElement(By.xpath(pro.getProperty("subjecterror7"))).getText();
				 ...
				 WebElement element2 = wait.until(ExpectedConditions.elementToBeClickable(By.xpath(pro.getProperty("subject7")))); 
