...
public class AdminUser extends TestBase1{
	Random r=new Random();
			...
			public void userAccess() throws Exception {
				...
				Thread.sleep(1000);
				 JavascriptExecutor js= (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);
				   Actions actn1=new Actions(driver);
					actn1.moveToElement(driver.findElement(By.xpath("//*[@id=\"user_access_form\"]/div[1]/div/div/table/tbody/tr[44]/td[2]/label/span"))).click().build().perform();
