...
public class AutoRedirectToBestOfferRailOne extends TestBase1{
	Random r=new Random();

	public AutoRedirectToBestOfferRailOne() {
	super();
	}
...
//	}
	 ...
	 @Test(priority=1)
	 public void systemSettingRedirectingToBestOffer() throws Exception {
		 Thread.sleep(5000);
	 ...
	 @Test(priority=2)
	  ...
	  @Test(priority=3)	  	
		public void createApplicationRailOneRedirectToBestOffer() throws Exception {
			Thread.sleep(3000);
	 	   ...
	 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
				   ...
				   try {
					     ...
					     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Hannah");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
				   ...
				   try {
					   ...
					   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("Mackenzie");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
