...
public class AutoRedirectToBestOffersRailTwo extends TestBase1{
	Random r=new Random();

	public AutoRedirectToBestOffersRailTwo() {
	super();
	}
...
//		           actn.moveToElement(driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[12]/div/label[2]/span"))).click().build().perform();
//		           Thread.sleep(2000);
//		           driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[13]/div/input")).click();
//		           driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[13]/div/input")).clear();
//		           driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[13]/div/input")).sendKeys("10");
//		           Thread.sleep(2000);
...
//				Assert.assertEquals(pwdtext1,"System Settings updated successfully.");	 }
	...
	@Test(priority=2)
	public void systemSettingRailTwo() throws Exception {
		Thread.sleep(7000);
	...
	//note:changes done
	@Test(priority=3)
	public void createApplicationRailTwoRedirectToBestOffer() throws Exception {
		Thread.sleep(3000);
