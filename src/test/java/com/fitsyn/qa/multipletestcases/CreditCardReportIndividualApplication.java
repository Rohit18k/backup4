...
public class CreditCardReportIndividualApplication extends TestBase1{

	Random r=new Random();
	
	public CreditCardReportIndividualApplication() {
	super();
	}
	...
	public void openBrowser() throws Exception {
	 ...
	 @Test(priority=1)
	  ...
	  @Test(priority=2)	  	
			public void createIndividualApplicationCreditReport() throws Exception {
		  Thread.sleep(3000);
	 	   ...
	 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
					   ...
					   try {
						     ...
						     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Bill");
							 }catch(Exception e) {
								 e.printStackTrace();
							 }
		  ...
		  driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).clear();
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).sendKeys("mock+265@evenfinancial.com");}
						...
						driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[3]/div/input")).sendKeys("1600 SUNFLOWER AVE");
						...
						driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).sendKeys("COSTA MESA");
						...
						slt2.selectByVisibleText("California");
						Thread.sleep(2000);
						...
						driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).sendKeys("92626");
...
//									   Assert.assertEquals(acttitle, expttitle);
									 ...
									 JavascriptExecutor js821 = (JavascriptExecutor) driver;
									   js821.executeScript("window.scrollBy(0,1500)");//else use 4000
									   Thread.sleep(5000);
