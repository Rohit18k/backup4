...
public class CreditCardReportJointApplication extends TestBase1{

	Random r=new Random();
	
	public CreditCardReportJointApplication() {
	super();
	}
...
//	}
	...
	public void subaccountSettingRailTwo() throws Exception {
		...
		actn.moveToElement(driver.findElement(By.xpath("//*[@id=\"table_content\"]/div/table/tbody/tr/td[8]/div//button[@class='btn btn-default btn-sm dropdown-toggle']"))).click().build().perform();
		Thread.sleep(7000);
...
*/
	 ...
	 @Test(priority=2)
		public void createApplicationRailTwoCreditReport() throws Exception {
			Thread.sleep(3000);
	 	...
	 	driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[2]/div//input[@placeholder='Enter Email']")).sendKeys("mock+265@evenfinancial.com");}
	 		...
	 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 		   js3.executeScript("window.scrollBy(0,50)");
	 			...
	 			driver.findElement(By.xpath("//input[@id='co_app']")).click();
	 			 Thread.sleep(1000);
	 			driver.findElement(By.xpath("//input[@name='co_app_first_name']")).sendKeys("Cary");
	 			 Thread.sleep(1000);
	 			driver.findElement(By.xpath("//input[@name='co_app_last_name']")).sendKeys("Testcase");
	 			 Thread.sleep(1000);
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[6]/div/input")).sendKeys("000-00-0018");
	 			 ...
	 			 Thread.sleep(1000);
	 			driver.findElement(By.xpath("//input[@placeholder='Type address here..']")).sendKeys("784 Beach Blvd");
	 			 Thread.sleep(2000);
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[8]/div/input")).sendKeys("Anthill");
	 			 Thread.sleep(1000);
	 			Select slt4=new Select(driver.findElement(By.xpath("//select[@name='co_app_state']")));
	 			slt4.selectByValue("MO");
	 			 Thread.sleep(1000);
	 			driver.findElement(By.xpath("//input[@name='co_app_zipcode']")).sendKeys("65488");
	 			 Thread.sleep(1000);
	        ...
	        actn4.moveToElement( driver.findElement(By.xpath("//*[@id=\"creditReport\"]/div/a/strong"))).click().build().perform();
...
//				        actn7.moveToElement( driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[7]/label/span"))).click().build().perform();
				        Thread.sleep(2000);
						...
						action5.moveToElement(driver.findElement(By.xpath("//*[@id=\"sms_history\"]/div/div/div[3]/button"))).click().build().perform();			        
						 ...
						 Thread.sleep(15000);
							 JavascriptExecutor js821 = (JavascriptExecutor) driver;
							   js821.executeScript("window.scrollBy(0,3000)");
