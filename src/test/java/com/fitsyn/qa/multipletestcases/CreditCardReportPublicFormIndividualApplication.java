...
public class CreditCardReportPublicFormIndividualApplication extends TestBase1{


	public CreditCardReportPublicFormIndividualApplication() {
	super();
	}
...
//	}
	 ...
	 @Test(priority=1)
	    ...
	    @Test(priority=2)
		public void publicFormCreateApplicationRailOneCreditReport() throws Exception {
			Thread.sleep(5000);
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
			   ...
			   try {
				     ...
				     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[1]/div/input[1]")).sendKeys("Bill");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
			   ...
			   try {
				   ...
				   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[2]/div/input")).sendKeys("Testcase");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
			   ...
			   try {
					  ...
					  driver.findElement(By.xpath("//*[@id=\"ssn_number\"]")).sendKeys("000-00-0015");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
				 Thread.sleep(1000);
			...
			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[9]/div/input")).sendKeys("mock+265@evenfinancial.com");}
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[10]/div/input")).sendKeys("1600 SUNFLOWER AVE");
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[11]/div/input")).sendKeys("COSTA MESA");
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[12]/div/div/div/ul/li[6]/a/span[1]")).click();
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[13]/div/input")).sendKeys("92626");
			...
			Thread.sleep(3000); 
				...
				Thread.sleep(3000);
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[15]/div/div/div/ul/li[1]/a")).click();
...
//					Thread.sleep(3000);
//					driver.findElement(By.xpath("//*[@id=\"credit_card_block\"]/div[2]/div/div/div/button/span[1]")).click();
//					Thread.sleep(3000);
//					driver.findElement(By.xpath("//*[@id=\"credit_card_block\"]/div[2]/div/div/div/div/ul/li[3]/a")).click();
