...
public class CreditCardReportPublicFormJointApplication extends TestBase1{


	public CreditCardReportPublicFormJointApplication() {
	super();
	}
...
//	}
	...
	public void subaccountSettingRailTwo() throws Exception {
	 ...
	 @Test(priority=2)
		public void publicFormCreateApplicationRailTwoCreditReport() throws Exception {
			Thread.sleep(7000);
	       ...
	       driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[7]/div/input[1]")).sendKeys("Condi");
	       ...
	       driver.findElement(By.xpath("//*[@id=\"social_security_number\"]")).sendKeys("000000017");
	      ...
	      Assert.assertEquals(actual13, exp13);
	   	  ...
	   	  driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[14]/div/input")).sendKeys("784 Beach Blvd");
	      ...
	      Assert.assertEquals(actual14, exp14);
	   	   ...
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[15]/div/input")).sendKeys("Anthill");
	      ...
	      Assert.assertEquals(actual15, exp15);
	 	  ...
	 	  Thread.sleep(3000);
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[16]/div/div/div/ul/li[27]/a/span[1]")).click();
	     ...
	     Assert.assertEquals(actual16, exp16);
	   	   ...
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[17]/div/input")).sendKeys("65488");
	   	Thread.sleep(3000);
	    ...
	    Assert.assertEquals(actual23, exp23);
	 	   ...
	 	   driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[2]/div/input")).sendKeys("Cary");
	 	   driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[3]/div/input")).sendKeys("Testcase");
	 	  Thread.sleep(3000);
	 	   driver.findElement(By.xpath("//*[@id=\"co_app_dob\"]")).sendKeys("12/21/1998");
	 	//  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[5]/div/input")).sendKeys("000000018"); 
	 	   //note:need to update it
	 	   
	 	   driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[6]/div/input")).sendKeys("784 Beach Blvd");	   
	 	  Thread.sleep(3000);
	 	  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[7]/div/input")).sendKeys("Anthill");

	 	  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[8]/div/div/button/span[1]")).click();
	 	 Thread.sleep(3000);
	 	 driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[8]/div/div/div/ul/li[27]/a/span[1]")).click();
	 	 
	 	 driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[9]/div/input")).sendKeys("65488");
	 	Thread.sleep(3000);
