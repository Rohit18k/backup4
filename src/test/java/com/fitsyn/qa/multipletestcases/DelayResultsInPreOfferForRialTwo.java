...
public class DelayResultsInPreOfferForRialTwo extends TestBase1{
	Random r=new Random();

	public DelayResultsInPreOfferForRialTwo() {
	super();
	}
...
//	}
	 ...
	 @Test(priority=1)
	 public void systemSettingPreOfferPageSeconds() throws Exception {
		 Thread.sleep(5000);
	...
	//note:changes done but need to run it pending
	
	
	  @Test(priority=2)
		public void showPreofferAfterpageDropdowmMenu() throws Exception {
			 Thread.sleep(5000);
...
//			   } 
	  ...
	  @Test(priority=4)
			public void createApplicationRailTwoAfterPreOfferConfirmationPage() throws Exception {
				Thread.sleep(3000);
		 	   ...
		 	   try {
		 		     ...
		 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Lily");
		 			 }catch(Exception e) {
		 				 e.printStackTrace();
		 			 }
		 	   ...
		 	   try {
		 		   ...
		 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Harlow");
		 			 }catch(Exception e) {
		 				 e.printStackTrace();
		 			 }
				...
				driver.findElement(By.xpath("//input[@placeholder='EX: 10000']")).sendKeys("100000");		 		
		 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
		 		   js3.executeScript("window.scrollBy(0,50)");
		 			...
		 			driver.findElement(By.xpath("//input[@name='co_app_first_name']")).sendKeys("Abigail");
		 			driver.findElement(By.xpath("//input[@name='co_app_last_name']")).sendKeys("Cassidy");
		 			Thread.sleep(2000);
...
//							   }
		  ...
		  @Test(priority=5)
			public void showPreofferBeforepageDropdowmMenu() throws Exception {
				 Thread.sleep(5000);
				driver.navigate().to("https://demo.fitsyn.com/settings/set_order");
				driver.manage().window().maximize();
				String Actttitle=driver.getTitle();
...
//				   } 
			...
			WebElement confirm=driver.findElement(By.xpath("//*[@id=\"show_confirmation_page\"]"));
			 ...
			 @Test(priority=6)
				public void createApplicationRailTwoBeforePreOfferConfirmationPage() throws Exception {
					Thread.sleep(3000);
					driver.navigate().to("https://demo.fitsyn.com/dashboard");
					driver.manage().window().maximize();
					Thread.sleep(3000);
					...
					driver.findElement(By.xpath("//input[@placeholder='EX: 10000']")).sendKeys("100000");
			 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
			 		   js3.executeScript("window.scrollBy(0,50)");
			 			...
			 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[6]/div/input")).sendKeys("000-00-0056");
			 			driver.findElement(By.xpath("//input[@placeholder='Type address here..']")).sendKeys("Washington Dc");
			 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[8]/div/input")).sendKeys("Florida");
			 			Select slt4=new Select(driver.findElement(By.xpath("//select[@name='co_app_state']")));
			 			slt4.selectByIndex(2);
