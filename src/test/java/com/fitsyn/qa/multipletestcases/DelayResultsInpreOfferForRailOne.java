...
//	
			   ...
			   js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
				...
				Thread.sleep(2000);
				 Actions actn=new Actions (driver);
		           ...
		           driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[24]/div/input")).sendKeys("10");
		           Thread.sleep(2000);
	...
	//note:to chcange xpath of submit button in system testing
...
//				   } 
	  ...
	  @Test(priority=4)	  	
		public void createApplicationRailOneAfterPreOfferConfirmationPage() throws Exception {
			Thread.sleep(3000);
...
//	  	   } 
	  ...
	  @Test(priority=6)	  	
			public void createApplicationRailOneBeforePreOfferConfirmationPage() throws Exception {
				Thread.sleep(3000);
				driver.navigate().to("https://demo.fitsyn.com/dashboard");
				driver.manage().window().maximize();
				Thread.sleep(3000);
