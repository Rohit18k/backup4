...
public class LenderOfferLimitRailOne  extends TestBase1{
	Random r=new Random();

	public LenderOfferLimitRailOne() {
	super();
	}
	...
	public void openBrowser() throws Exception {
	 ...
	 @Test(priority=1)
	 public void systemSettingLimitOffersPerLenderOfferLimit1() throws Exception {
		 Thread.sleep(5000);
...
//				Assert.assertEquals(pwdtext1,"System Settings updated successfully.");	 
	 ...
	 @Test(priority=2)
	  ...
	  @Test(priority=3)	  	
			public void createApplicationRailOneLimitoffer1() throws Exception {
				Thread.sleep(3000);
		 	   ...
		 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
					   ...
					   try {
						     ...
						     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Jasmine");
							 }catch(Exception e) {
								 e.printStackTrace();
							 }
					   ...
					   try {
						   ...
						   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("Monroe");
							 }catch(Exception e) {
								 e.printStackTrace();
							 }
...
//					Assert.assertEquals(pwdtext1,"System Settings updated successfully.");	
	  ...
	  @Test(priority=5)	  	
		public void CreateApplicationLimitOffer2() throws Exception {
			Thread.sleep(3000);
			driver.navigate().to("https://demo.fitsyn.com/dashboard");
			driver.manage().window().maximize();
			Thread.sleep(5000);
	 	   ...
	 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
				   ...
				   try {
					   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).click();
					   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("Fallon");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
				   String text2=driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[3]/div/label[2]")).getText();
