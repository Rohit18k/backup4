...
public class LenderOfferLimitRailTwo extends TestBase1{
	Random r=new Random();

	public LenderOfferLimitRailTwo() {
	super();
	}
	//note:changes done
...
//		           actn.moveToElement(driver.findElement(By.xpath("//*[@id=\"smtp_form_validation\"]/div[6]/div[27]/div/label[2]/span"))).click().build().perform();
//		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).clear();
//		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).sendKeys("1");
//		       	Thread.sleep(1000);
//		       	driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div")).click();
//		        Actions actn2=new Actions (driver);
//		           actn2.moveToElement(driver.findElement(By.xpath("//*[@id=\"median_offer\"]/div/label[2]/span"))).click().build().perform();
//		           Thread.sleep(2000);
...
//				Assert.assertEquals(pwdtext1,"System Settings updated successfully.");	 }
	...
	@Test(priority=1)
	 public void systemSettingLimitOffer1() throws Exception {
		 Thread.sleep(5000);
		  driver.navigate().to("https://demo.fitsyn.com/settings/");
			driver.manage().window().maximize();
			Thread.sleep(2000);
			 JavascriptExecutor js= (JavascriptExecutor) driver;
			   js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
				...
				Thread.sleep(2000);
				 Actions actn=new Actions (driver);
		           actn.moveToElement( driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input"))).click().build().perform();
		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).clear();
		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).sendKeys("1");
		       	Thread.sleep(1000);
		       	driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div")).click();
...
//				Assert.assertEquals(pwdtext1,"System Settings updated successfully.");	 
	 ...
	 @Test(priority=3)
		public void createApplicationRailTwoLimitoffer1() throws Exception {
			Thread.sleep(3000);
	 	   ...
	 	   try {
	 		     ...
	 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Evelyn");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   ...
	 	   try {
	 		   ...
	 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Delaney");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
			...
			driver.findElement(By.xpath("//input[@placeholder='EX: 10000']")).sendKeys("100000");		 		
	 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 		   js3.executeScript("window.scrollBy(0,50)");
	 			...
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[6]/div/input")).sendKeys("000-00-0034");
					 ...
					 Thread.sleep(15000);
						 JavascriptExecutor js82 = (JavascriptExecutor) driver;
						   js82.executeScript("window.scrollBy(0,3000)");
							   ...
							   WebElement element = driver.findElement(By.xpath("//*[@id=\"monevo_confirm_form\"]/div/div[1]/div/div/div/div/div/div[30]/div[2]/div[1]/input"));
							WebElement el4=   driver.findElement(By.xpath("/html/body/div[3]/div[2]/div/div[3]/form/div/div[2]/button"));
							Thread.sleep(5000);
			Actions builder=new Actions(driver);
			builder.moveToElement(element).click().build().perform();
			Thread.sleep(3000);
	      driver.findElement(By.xpath("//*[@id=\"monevo_confirm_form\"]/div/div[1]/div/div/div/div/div/div[30]/div[2]/div[2]/input")).click();
...
//	 	   js267.executeScript("window.scrollTo(0, document.body.scrollHeight)");
	 ...
	 @Test(priority=4)
	 public void systemSettingLimitOffer2() throws Exception {
		 Thread.sleep(5000);
		  driver.navigate().to("https://demo.fitsyn.com/settings/");
			driver.manage().window().maximize();
			Thread.sleep(2000);
			   ...
			   js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
				...
				Thread.sleep(2000);
				 Actions actn=new Actions (driver);
		           actn.moveToElement(driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input"))).click().build().perform();
		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).clear();
		           driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div/div[1]/div/input")).sendKeys("2");
		       	Thread.sleep(1000);
		       	driver.findElement(By.xpath("//*[@id=\"lender_offer_limit_block\"]/div")).click();
		           Thread.sleep(2000);
		           Actions actn1=new Actions (driver);
	 ...
	 @Test(priority=5)
		public void createApplicationRailTwoLimitoffer2() throws Exception {
			Thread.sleep(3000);
			driver.navigate().to("https://demo.fitsyn.com/dashboard");
			driver.manage().window().maximize();
			Thread.sleep(5000);
	 	   ...
	 	   try {
	 			  driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).click();
	 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Amelia");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   String text1=driver.findElement(By.cssSelector("label[for='last_name']")).getText();
	 	   ...
	 	   try {
	 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).click();
	 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Addison");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   String text2=driver.findElement(By.cssSelector("label[for='dob']")).getText();
			...
			driver.findElement(By.xpath("//input[@placeholder='EX: 10000']")).sendKeys("100000");		 		
	 		JavascriptExecutor js3 = (JavascriptExecutor) driver;
	 		   js3.executeScript("window.scrollBy(0,50)");
	 			...
	 			Thread.sleep(2000);
	 			driver.findElement(By.xpath("//input[@id='co_app_dob']")).sendKeys("12/21/1998");	 			
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[6]/div/input")).sendKeys("000-00-0018");
	 			driver.findElement(By.xpath("//input[@placeholder='Type address here..']")).sendKeys("Washington Dc");
	 			driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[5]/div[8]/div/input")).sendKeys("Florida");
	 			Select slt4=new Select(driver.findElement(By.xpath("//select[@name='co_app_state']")));
	 			slt4.selectByIndex(2);
