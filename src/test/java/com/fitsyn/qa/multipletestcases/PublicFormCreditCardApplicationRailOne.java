...
public class PublicFormCreditCardApplicationRailOne extends TestBase1{


	public PublicFormCreditCardApplicationRailOne() {
	super();
	}
	   ...
	   @Test(priority=2)
			public void publicForm() throws Exception {
				...
				Thread.sleep(5000);
				  ...
				  action6.moveToElement(driver.findElement(By.xpath("//a[normalize-space()='Apply for Credit Card']"))).click().build().perform();
