...
public class RepresentativeCreateApplicationOptInProcessRailOne extends TestBase1{


	public RepresentativeCreateApplicationOptInProcessRailOne() {
	super();
	}
	...
	public  void subaccountSettingRailOne() throws Exception {
	 ...
	 @Test(priority=2)
		public  void searchRepresentativeInUserListPage() throws Exception {
			Thread.sleep(4000);
	 ...
	 @Test(priority=3)	  	
		public void createRepresentativeApplicationRailOneOptin() throws Exception {
			Thread.sleep(5000);
