...
public class RepresentativeCreateApplicationOptInRailTwo extends TestBase1{


	public RepresentativeCreateApplicationOptInRailTwo() {
	super();
	}
	//note: search representative
...
//	}
	  ...
	  @Test(priority=2)
		public  void searchRepresentativeInUserList() throws Exception {
			Thread.sleep(3000);
			...
			Thread.sleep(3000);
			Actions actn=new Actions(driver);
			actn.moveToElement(driver.findElement(By.xpath("//*[@id=\"table_content\"]/div/table/tbody/tr/td[7]/div/a"))).click().build().perform();
			Thread.sleep(12000);
			driver.manage().window().maximize();}
	
	  @Test(priority=3)
		public void CreateRepresentativeApplicationOptInRailTwo() throws Exception {
			Thread.sleep(3000);
	 	   ...
	 	   try {
	 		     ...
	 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Isabella	");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	   ...
	 	   try {
	 		   ...
	 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Lane");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
