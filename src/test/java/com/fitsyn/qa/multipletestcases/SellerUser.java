...
public class SellerUser extends TestBase1{
	Random r=new Random();
...
//	}
	  ...
	  @Test(priority=1)
	public void userSeller() throws Exception {
		Thread.sleep(2000);
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div/div/div/div/section/div/div/form/div[1]/div[8]/div//input")).sendKeys("Financing");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div/div/div/div/section/div/div/form/div[1]/div[9]/div//input")).sendKeys("Washington DC");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div/div/div/div/section/div/div/form/div[1]/div[10]/div//input")).sendKeys("USA");
		Thread.sleep(1000);
		Select slt1=new Select(driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div/div/div/div/section/div/div/form/div[1]/div[11]/div/select")));
		Thread.sleep(2000);
		slt1.selectByVisibleText("Texas");
		Thread.sleep(1000);
		driver.findElement(By.xpath("//*[@id=\"ajax_content\"]/div/div/div/div/section/div/div/form/div[1]/div[12]/div/input")).sendKeys("12345");
			...
			public void userAccess() throws Exception {
				...
				Thread.sleep(1000);
				 JavascriptExecutor js= (JavascriptExecutor) driver;
				   ...
				   Thread.sleep(1000);
				   Actions actn1=new Actions(driver);
					actn1.moveToElement(driver.findElement(By.xpath("//*[@id=\"user_access_form\"]/div[1]/div/div/table/tbody/tr[10]/td[2]/label/span"))).click().build().perform();
