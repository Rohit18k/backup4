...
public class InSchedularSideMenuApplicantSMSSchedular extends TestBase1{

	Random r=new Random();
	
	public InSchedularSideMenuApplicantSMSSchedular() {
	super();
	}
...
//	}
	...
	public void addSchedularOfferClicked() throws Exception {
		 Thread.sleep(2000);
			driver.navigate().to("https://demo.fitsyn.com/scheduler/applicant/sms");	
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	   action7.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[1]/ul/li[2]"))).click().build().perform();
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("offer clicked");
		 	  Thread.sleep(1000);
		 	 ...
		 	 Actions action5=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);
			 	...
			 	Actions action10=new Actions(driver);
			 	   action10.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/a"))).click().build().perform();
			 		 Thread.sleep(1000);
			 	 
			 	Actions action9=new Actions(driver);
			 	   action9.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/button"))).click().build().perform();
			 	 ...
			 	 Actions action8=new Actions(driver);
					...
					Assert.assertEquals(success,"Applicant SMS Scheduler successfully created");
		 	 ...
		 	 Actions actn2=new Actions(driver);
				...
				driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/input")).sendKeys("2");
				 ...
				 Actions actn5=new Actions(driver);
					actn5.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/a"))).click().build().perform();
				 
				 Actions actn4=new Actions(driver);
					actn4.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/button"))).click().build().perform();
					 Thread.sleep(2000);
					 ...
					 driver.switchTo().defaultContent();
						 ...
						 Actions actn6=new Actions(driver);
							...
							Thread.sleep(4000);
							String success=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
							Assert.assertEquals(success,"Applicant SMS Scheduler successfully updated");
							}
		 ...
		 Thread.sleep(2000);
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("funded");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
	...
	@Test(priority=7)
	public void addSchedularApplicationsent() throws Exception {
		 Thread.sleep(2000);
			driver.navigate().to("https://demo.fitsyn.com/scheduler/applicant/sms");	
			driver.manage().window().maximize();
			Thread.sleep(2000);
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("Application sent to applicant");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
		 ...
		 Thread.sleep(2000);
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("looking for an offer");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
				...
				driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/input")).sendKeys("2");
				 ...
				 Actions actn4=new Actions(driver);
					actn4.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/button"))).click().build().perform();
					 ...
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).click();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).clear();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).sendKeys("looking for an offer");		
					 driver.switchTo().defaultContent();
		 ...
		 Thread.sleep(2000);
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("No offers");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
		 ...
		 Thread.sleep(2000);
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("Offers available");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
				...
				driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/input")).sendKeys("2");
				 ...
				 Actions actn4=new Actions(driver);
					actn4.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/button"))).click().build().perform();
					 ...
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).click();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).clear();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).sendKeys("offer available");		
					 driver.switchTo().defaultContent();
						Thread.sleep(1000);
						 Actions actn6=new Actions(driver);
							actn6.moveToElement(driver.findElement(By.xpath("//*[@id=\"submit-btn\"]"))).click().build().perform();
		 ...
		 Thread.sleep(2000);
			...
			Actions action=new Actions(driver);
		 	 ...
		 	 Actions action7=new Actions(driver);
		 	  ...
		 	  Thread.sleep(1000);		 	  
		 	 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).click();
			 driver.findElement(By.xpath("//*[@id=\"sms_body\"]")).sendKeys("rejected");
		 	  Thread.sleep(1000);
		 	 driver.findElement(By.xpath("//*[@id=\"submit-btn\"]")).click();
		 	Thread.sleep(4000);
			String error1=driver.findElement(By.xpath("/html/body/div[10]/span[3]")).getText();
				...
				driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/input")).sendKeys("2");
				 ...
				 Actions actn4=new Actions(driver);
					actn4.moveToElement(driver.findElement(By.xpath("//*[@id=\"scheduler_form_validation\"]/div[3]/ul/li[1]/button"))).click().build().perform();
					 ...
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).click();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).clear();		
					 driver.findElement(By.xpath("/html/body[@class=\"cke_editable cke_editable_themed cke_contents_ltr cke_show_borders\"]")).sendKeys("rejected");		
					 driver.switchTo().defaultContent();
						Thread.sleep(1000);
						 Actions actn6=new Actions(driver);
							actn6.moveToElement(driver.findElement(By.xpath("//*[@id=\"submit-btn\"]"))).click().build().perform();
