...
public class IndividualApplicationInvalidData extends TestBase1{

	Random r=new Random();
	
	public IndividualApplicationInvalidData() {
	super();
	}
	//need to test it
	 ...
	 @Test(priority=2)	  	
		public void fillForm() throws Exception {
	 	   ...
	 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
				   ...
				   try {
					     ...
					     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Leah");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
				   ...
				   try {
					   ...
					   driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[2]/div/input")).sendKeys("Harlow");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
				   ...
				   try {
						  ...
						  driver.findElement(By.xpath("//*[@id=\"ssn_number\"]")).sendKeys("000-00-0034");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
					 Thread.sleep(1000);
	  ...
	  driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).clear();
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).sendKeys("mock+265@evenfinancial.com");}
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[3]/div/input")).sendKeys("71 ST. NICHOLAS DRIVE");
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).sendKeys("NORTH POLE");
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).sendKeys("65489");
