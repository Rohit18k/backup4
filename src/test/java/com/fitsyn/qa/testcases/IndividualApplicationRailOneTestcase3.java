...
public class IndividualApplicationRailOneTestcase3 extends TestBase1{

	Random r=new Random();
	
	public IndividualApplicationRailOneTestcase3() {
	super();
	}
	//need to test it
	 ...
	 @Test(priority=2)	  	
		public void fillForm() throws Exception {
	 	   ...
	 	   action.moveToElement(driver.findElement(By.cssSelector("#submit-btn"))).click().build().perform();
				   ...
				   try {
					     ...
					     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[1]/div[1]/div/input[1]")).sendKeys("Condi");
						 }catch(Exception e) {
							 e.printStackTrace();
						 }
	  ...
	  driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).clear();
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[2]/div/input")).sendKeys("mock+265@evenfinancial.com");}
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[3]/div/input")).sendKeys("784 Beach Blvd");
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[4]/div/input")).sendKeys("Anthill");
					...
					slt2.selectByVisibleText("Missouri");
					Thread.sleep(2000);
					...
					driver.findElement(By.xpath("//*[@id=\"application_form\"]/div[2]/div[6]/div/input")).sendKeys("65488");
