...
//	}
	...
	public void fillForm() throws Exception {
     ...
     Assert.assertEquals(actual16, exp16);
   	   ...
   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[17]/div/input")).sendKeys("12345");
   	Thread.sleep(3000);
    ...
    Assert.assertEquals(actual23, exp23);
 	  ...
 	  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[5]/div/input")).sendKeys("000000045");
 	   
 	   driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[6]/div/input")).sendKeys("1701 Pennsylvania Ave NW Frnt 1");	   
 	  Thread.sleep(3000);
 	  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[7]/div/input")).sendKeys("US");
 	  
 	  driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[8]/div/div/button/span[1]")).click();
 	 Thread.sleep(3000);
 	 driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[8]/div/div/div/ul/li[6]/a/span[1]")).click();
 	 
 	 driver.findElement(By.xpath("//*[@id=\"insertDetails\"]/div[9]/div/input")).sendKeys("12345");
 	Thread.sleep(3000);
