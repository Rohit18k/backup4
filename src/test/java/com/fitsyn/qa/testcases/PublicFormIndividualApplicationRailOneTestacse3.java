...
public class PublicFormIndividualApplicationRailOneTestacse3 extends TestBase1{


	public PublicFormIndividualApplicationRailOneTestacse3() {
	super();
	}
...
//	}
    ...
    @Test(priority=1)
		public void publicForm() throws Exception {
			...
			JavascriptExecutor js = (JavascriptExecutor) driver;
			   ...
			   try {
				     ...
				     driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[1]/div/input[1]")).sendKeys("Condi");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
			   ...
			   try {
					  ...
					  driver.findElement(By.xpath("//*[@id=\"ssn_number\"]")).sendKeys("000-00-0017");
					 }catch(Exception e) {
						 e.printStackTrace();
					 }
				 Thread.sleep(1000);
			...
			driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[9]/div/input")).sendKeys("mock+265@evenfinancial.com");}
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[10]/div/input")).sendKeys("784 Beach Blvd");
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[11]/div/input")).sendKeys("Anthill");
		...
		Thread.sleep(3000);
		driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[12]/div/div/div/ul/li[27]/a")).click();
				...
				driver.findElement(By.xpath("//*[@id=\"application_form\"]/div/div[1]/div/div/div/div/div/div[13]/div/input")).sendKeys("65488");
