...
//pending to test
public class PublicFormIndividualApplicationTestcase1 extends TestBase1{


	public PublicFormIndividualApplicationTestcase1() {
	super();
	}
...
//	}
	 ...
	 @Test(priority=2)
		public void fillForm() throws Exception {
	       ...
	       driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[7]/div/input[1]")).sendKeys("Bill");
	       ...
	       driver.findElement(By.xpath("//*[@id=\"social_security_number\"]")).sendKeys("000000015");
	      ...
	      Assert.assertEquals(actual13, exp13);
	   	  ...
	   	  driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[14]/div/input")).sendKeys("1600 SUNFLOWER AVE");
	      ...
	      Assert.assertEquals(actual14, exp14);
	   	   ...
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[15]/div/input")).sendKeys("COSTA MESA");
	      ...
	      Assert.assertEquals(actual15, exp15);
	 	  ...
	 	  Thread.sleep(3000);
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[16]/div/div/div/ul/li[6]/a/span[1]")).click();
	     ...
	     Assert.assertEquals(actual16, exp16);
	   	   ...
	   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[17]/div/input")).sendKeys("92626");
	   	Thread.sleep(3000);
