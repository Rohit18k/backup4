...
public class PublicFormInvalidIndividualApplication extends TestBase1{
	//pending to test

	public PublicFormInvalidIndividualApplication() {
	super();
	}
...
//	}
	...
	public void fillForm() throws Exception {
       ...
       driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[7]/div/input[1]")).sendKeys("Sunrise");
       ...
       driver.findElement(By.xpath("//*[@id=\"social_security_number\"]")).sendKeys("000000025");
      ...
      Assert.assertEquals(actual13, exp13);
   	  ...
   	  driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[14]/div/input")).sendKeys("71 ST. NICHOLAS DRIV");
      ...
      Assert.assertEquals(actual14, exp14);
   	   ...
   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[15]/div/input")).sendKeys("NORTH POLE");
      ...
      Assert.assertEquals(actual15, exp15);
 	  ...
 	  Thread.sleep(3000);
   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[1]/div/div/div/div/div/div/div[16]/div/div/div/ul/li[3]/a/span[1]")).click();
     ...
     Assert.assertEquals(actual16, exp16);
   	   ...
   	   driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div/div[1]/div/div/div/div/div/div[17]/div/input")).sendKeys("99705");
   	Thread.sleep(3000);
