...
//		   } 
	...
	public void createApplicationRailTwoBeforePreOfferConfirmationPage() throws Exception {
 	   ...
 	   try {
 		     ...
 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Harper");
 			 }catch(Exception e) {
 				 e.printStackTrace();
 			 }
 	   ...
 	   try {
 		   ...
 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Mackenzie");
 			 }catch(Exception e) {
 				 e.printStackTrace();
 			 }
