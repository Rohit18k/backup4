...
public class RepresentativeRailOnePOSTAPIAboveAge extends TestBase1{


	public RepresentativeRailOnePOSTAPIAboveAge() {
	super();
	}
...
//			driver.manage().window().maximize();}
	...
	driver.findElement(By.cssSelector("#submit-btn")).click();
	 ...
	 //note: looking for an offer after post api, then submit then offer availabe
