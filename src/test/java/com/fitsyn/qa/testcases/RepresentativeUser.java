...
public class RepresentativeUser extends TestBase1{
	Random r=new Random();
...
//	}
	  ...
	  @Test(priority=1)
	public void userRepresentative() throws Exception {
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		slt1.selectByVisibleText("Admin Admin(super_admin)");
		...
		public void userAccess() throws Exception {
			...
			Thread.sleep(1000);
			 JavascriptExecutor js= (JavascriptExecutor) driver;
			   ...
			   Thread.sleep(1000);
			   Actions actn1=new Actions(driver);
				actn1.moveToElement(driver.findElement(By.xpath("//*[@id=\"user_access_form\"]/div[1]/div/div/table/tbody/tr[48]/td[2]/label/span"))).click().build().perform();
