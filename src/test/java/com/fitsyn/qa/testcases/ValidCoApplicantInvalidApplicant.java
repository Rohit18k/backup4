...
public class ValidCoApplicantInvalidApplicant extends TestBase1{

	Random r=new Random();
	
	public ValidCoApplicantInvalidApplicant() {
	super();
	}
		...
		public void fillForm() throws Exception {
	 	  ...
	 	  Thread.sleep(1000);
	 	   ...
	 	   try {
	 		     ...
	 		     driver.findElement(By.cssSelector("input[placeholder='Enter first name'][name='first_name']")).sendKeys("Sunrise");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	  Thread.sleep(1000);
	 	   ...
	 	   try {
	 		   ...
	 		   driver.findElement(By.cssSelector("input[placeholder='Enter last name'][name='last_name']")).sendKeys("Test");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 	  Thread.sleep(1000);
	 	  ...
	 	  Thread.sleep(1000);
	 	   ...
	 	   try {
	 			  ...
	 			  driver.findElement(By.cssSelector("#social_security_number")).sendKeys("000-00-0025");
	 			 }catch(Exception e) {
	 				 e.printStackTrace();
	 			 }
	 		 Thread.sleep(1000);
	 	...
	 	driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[2]/div//input[@placeholder='Enter Email']")).sendKeys("mock+265@evenfinancial.com");}
	 		...
	 		driver.findElement(By.xpath("//input[@placeholder='Enter Address']")).sendKeys("71 ST. NICHOLAS DRIV");
	 		 Thread.sleep(1000);
	 		...
	 		driver.findElement(By.xpath("//input[@name='city']")).sendKeys("NORTH POLE");
	 		...
	 		driver.findElement(By.xpath("//*[@id=\"new_application_form\"]/div[3]/div[6]/div/input")).sendKeys("99705");
	 		 Thread.sleep(1000);
